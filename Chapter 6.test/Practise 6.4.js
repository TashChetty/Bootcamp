...
for(let i=0; i<10; i++){        //loop + 2 values
  let num1 = 5 * i;
  let num2 = i * i;
  let result = calculate(num1, num2, "+"); // calling calculation function
  nums.push(result);    //pushing result into array
}
console.log(nums);
function calculate(param1, param2, operator) {        //function returns value of 2 parameters passed
  if (operator == "-") {
