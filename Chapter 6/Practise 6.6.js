...
function Factorial(num) {   //function
    console.log(num);
    if (num === 0) {    //condition checking if the argument value is 0.
        return 1;   //if parameter is zero, return 1
    } 
    else { 
        return num * Factorial(--num); // return the value of the argument multiplied by the value returned subtracting one from the value of the argument
       
    } 
} 
console.log(Factorial(2));  //invoke function and change numb
